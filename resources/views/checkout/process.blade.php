    ...
    <div class="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <form class="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                        ...
                        <div class="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                            <div class="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                                ...
                                <div class="mt-4 sm:mt-0 sm:pr-9">
                                    ...
                                    <!-- Dropdown -->
                                    <div class="relative inline-block text-left w-16" x-data="{ open: false, toggle() { this.open = !this.open },
                            closeOnClickAway(event) { if (!this.$el.contains(event.target)) { this.open = false } } }"
                                        @click.away="closeOnClickAway">

                                        <!-- Button -->
                                        <div>
                                            <button type="button" class="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white 
                                py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300
                                hover:bg-gray-50 focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent"
                                        ...
                                        <!-- dropdown menu -->
                                        <div class="absolute right-0 z-10 mt-2 w-16 origin-top-right rounded-md
                                bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu"
                                            ...
                                            <div class="py-1" role="none">
                                                ...
                                                <a href="#"
                                                    class="text-gray-700 block px-4 py-2 text-sm hover:bg-accent hover:text-white hover:duration-200 rounded-md"
                                                    role="menuitem" tabindex="-1" id="menu-item-0">1</a>
                                                <a href="#"
                                                    class="text-gray-700 block px-4 py-2 text-sm hover:bg-accent hover:text-white hover:duration-200 rounded-md"
                                                    role="menuitem" tabindex="-1" id="menu-item-1">2</a>
                                                <a href="#"
                                                    class="text-gray-700 block px-4 py-2 text-sm hover:bg-accent hover:text-white hover:duration-200 rounded-md"
                                                    role="menuitem" tabindex="-1" id="menu-item-2">3</a>
                                                <form method="POST" action="#" role="none">
                                                    <button type="submit" class="text-gray-700 block w-full px-4 py-2 text-left text-sm 
                                        hover:bg-accent hover:text-white hover:duration-200 rounded-md" role="menuitem"
                                                        tabindex="-1" id="menu-item-3">4</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                    <!--                                     
                        <select id="quantity-0" name="quantity-0" class="max-w-full rounded-md border
                         border-gray-300 py-1.5 text-left text-base font-medium leading-5 text-gray-700 shadow-sm
                          focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent sm:text-sm">
            ...
            <section aria-labelledby="summary-heading"
                class="mt-16 rounded-lg bg-light-grey px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
                ...
                <div class="mt-6">
                    <button type="submit" class="w-full rounded-md border border-transparent bg-accent hover:duration-200
           px-4 py-3 text-base font-medium text-white hover:text-black shadow-sm hover:bg-secondary 
           focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50">Checkout</button>
                </div>
            </section>
        </form>
    </div>
