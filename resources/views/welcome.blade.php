                                    ...
                                    <div class="flex items-center space-x-6 lg:space-x-8">
                                        <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                                            <div
                                                ...
                                                <img src="https://tinyurl.com/ywrvgryr" alt=""
                                                    class="h-full w-full object-cover object-center">
                                            </div>
                                            <div class="h-64 w-44 overflow-hidden rounded-lg">
                                                <img src="https://tinyurl.com/yp7rtwer" alt=""
                                                    class="h-full w-full object-cover object-center">
                                            </div>
                                        </div>
                                        <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                                            <div class="h-64 w-44 overflow-hidden rounded-lg">
                                                <img src="https://tinyurl.com/ys3cgyjz" alt=""
                                                    class="h-full w-full object-cover object-center">
                                            </div>
                                            <div class="h-64 w-44 overflow-hidden rounded-lg">
                                                <img src="https://tinyurl.com/yoevvb6c" alt=""
                                                    class="h-full w-full object-cover object-center">l
                                            </div>
                                            <div class="h-64 w-44 overflow-hidden rounded-lg">
                                                <img src="https://tinyurl.com/yw6thpkx" alt=""
                                                    class="h-full w-full object-cover object-center">
                                            </div>
                                        </div>
                                        <div class="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                                            <div class="h-64 w-44 overflow-hidden rounded-lg">
                                                <img src="https://tinyurl.com/yk9uawgc" alt=""
                                                    class="h-full w-full object-cover object-center">
                                            </div>
                                            <div class="h-64 w-44 overflow-hidden rounded-lg">
                                                <img src="https://tinyurl.com/yr5cpxm6" alt=""
                                                    class="h-full w-full object-cover object-center">
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="mx-auto max-w-[2000px] mb-[100px] px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img src="https://images.pexels.com/photos/8063850/pexels-photo-8063850.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                                alt="orange clay jugs on a table" class="object-cover object-center">
                        ...
                        <div
                            ...
                            <img src="https://tinyurl.com/yrprq2e8" alt="diamond drop earrings on a blue background"
                        ...
                        <div
                            ...
                            <img src="https://images.pexels.com/photos/18946616/pexels-photo-18946616/free-photo-of-schreibtisch-pflanze-fenster-zimmer.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                        ...
                        <div
                            ...
                            <img src="https://images.pexels.com/photos/1579708/pexels-photo-1579708.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                                alt="wall with many different paintings" class="object-cover object-center">
                        ...
                        <div
                            class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-none sm:relative sm:h-full transition ease-in-out delay-[20ms] hover:scale-105 hover:shadow">
                            <img src="https://tinyurl.com/yocfe2m8" alt="a hanging rack in an industrial like room"
                                class="object-cover object-center sm:absolute sm:inset-0 sm:h-full sm:w-full">
                            <div aria-hidden="true"
                                class="bg-gradient-to-b from-transparent to-black opacity-50 sm:absolute sm:inset-0">
                            </div>
                        ...
                        <div
                            class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-none sm:relative sm:h-full transition ease-in-out delay-[20ms] hover:scale-105 hover:shadow">
                            <img src="https://images.pexels.com/photos/313707/pexels-photo-313707.jpeg?auto=compress&cs=tinysrgb&w=600"
                        ...
                        <div
                            class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-none sm:relative sm:h-full transition ease-in-out delay-[20ms] hover:scale-105 hover:shadow">
                            <img src="https://images.pexels.com/photos/3661222/pexels-photo-3661222.jpeg?auto=compress&cs=tinysrgb&w=600"
                        ...
                        <div
                            class="group aspect-h-1 aspect-w-2 overflow-hidden rounded-lg sm:aspect-none sm:relative sm:h-full transition ease-in-out delay-[20ms] hover:scale-105 hover:shadow">
                            <img src="https://images.pexels.com/photos/247929/pexels-photo-247929.jpeg?auto=compress&cs=tinysrgb&w=600"
            ...
            <section aria-labelledby="cause-heading">
                <div class="relative bg-gray-800 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
                    <div class="absolute inset-0 overflow-hidden">
                        <img src="https://images.pexels.com/photos/1072824/pexels-photo-1072824.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
