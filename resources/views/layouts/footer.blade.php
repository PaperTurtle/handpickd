<footer class="bg-primary mt-10">
    <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-5 lg:px-8">
        <nav class="-mb-6 flex justify-center space-x-1 sm:flex sm:justify-center sm:space-x-12 font-medium flex-wrap gap-2 sm:gap-4"
            aria-label="Footer">
            <div class="pb-6">
        ...
        <div class="mt-10 flex justify-center space-x-10">
            <a href="https://github.com/PaperTurtle/handpickd"
