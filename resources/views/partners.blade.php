    ...
    <div class="relative px-6 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div class="text-center">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl font-heading">Our Partners</h1>
                <p class="mt-6 text-lg leading-8 text-gray-600">We are proud to collaborate with a diverse group of
                    partners who have made this project possible. Their support and contributions have been instrumental
                    in bringing our vision to life.</p>
