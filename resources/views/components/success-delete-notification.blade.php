            ...
            <div class="p-4">
                <div class="flex items-start">
                    ...
                    <div class="ml-3 w-0 flex-1 pt-0.5">
                        <h3 class="text-lg font-medium text-text">Review deleted successfully!</h3>
                        <p class="mt-1 text-sm text-gray-500">Your review has been successfully deleted. We're sorry to
                            see your feedback go, but we respect your decision. Thank you for your previous
                            contributions.
                        </p>
                    </div>
