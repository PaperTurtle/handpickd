...
<x-app-layout>
    <div class="container mx-auto px-4 py-6 flex flex-col items-center justify-center sm:px-6 lg:px-8"
        x-data="{ images: [] }">
        <h1 class="text-2xl font-semibold leading-7 text-gray-900 font-heading mb-4 mt-4">Post New Product</h1>
        ...
        <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data"
            ...
            <!-- Submit Button -->
            <button class="block w-1/4 md:w-1/2 rounded-md bg-primary px-4 py-2 text-lg text-white shadow-sm"
