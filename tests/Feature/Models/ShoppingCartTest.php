...
it('belongs to a user', function () {
    ...
    $cartItem = \App\Models\ShoppingCart::factory()->create(['user_id' => $user->id]);
...
it('belongs to a product', function () {
    ...
    $cartItem = \App\Models\ShoppingCart::factory()->create(['product_id' => $product->id]);

    expect($cartItem->product)->toBeInstanceOf(Product::class);
});

it('has correct fillable attributes', function () {
    $cartItem = new \App\Models\ShoppingCart();
...
it('calculates total price correctly', function () {
    ...
    $cartItem = \App\Models\ShoppingCart::factory()->create([
...
it('can be created', function () {
    $cartItem = \App\Models\ShoppingCart::create([
