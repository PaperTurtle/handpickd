                    ...
                    <div class="mx-auto max-w-2xl space-y-8 sm:px-4 lg:max-w-4xl lg:px-0">
                        @foreach ($transactions as $timestamp => $group)
                            @php
                                ...
                                $orderNumber = 'Order#' . $date->format('YmdHi');
                            @endphp
                                    ...
                                    <div class="relative flex justify-end lg:hidden">
                                        <div class="flex items-center">
                                            <button type="button"
                                                ...
                                                <span class="sr-only">Options for order {{ $orderNumber }}</span>
                      ...
                      -->
                                    ...
                                    <div
                                        ...
                                        <a href="#"
                                            ...
                                            <span class="sr-only">{{ $orderNumber }}</span>
                                        </a>
                                        <a href="#"
                                            class="flex items-center justify-center rounded-md border border-gray-300 bg-white px-2.5 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                            <span>View Invoice</span>
                                            <span class="sr-only">for order {{ $orderNumber }}</span>
                                        </a>
                                    </div>
                                </div>
                                                ...
                                                <div class="mt-6 sm:flex sm:justify-between">
                                                    ...
                                                    @else
                                                        <div class="flex items-center">
                                                            ...
                                                            <p class="ml-2 text-sm font-medium text-gray-500">Delivered
                                                                on
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex flex-1 justify-center pl-4">
                                                            @if ($transaction->status !== 'sent')
                                                                <button x-on:click="markAsSent({{ $transaction->id }})"
