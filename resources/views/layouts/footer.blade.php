<footer class="bg-accent">
  <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-5 lg:px-8">
    <nav class="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12" aria-label="Footer">
      <div class="pb-6">
        <a href="#" class="text-sm leading-6 text-background hover:text-primary hover:font-bold">About</a>
      </div>
      <div class="pb-6">
      ...
      <div class="pb-6">
        <a href="#" class="text-sm leading-6 text-background hover:text-primary hover:font-bold">Accessibility</a>
      </div>
      <div class="pb-6">
    ...
    <div class="mt-10 flex justify-center space-x-10">
      ...
      <a href="#" class="text-background hover:text-primary">
